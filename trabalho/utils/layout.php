...
class Layout
{
    ...
    <header class="p-3 mb-3 border-bottom shadow">
        ...
        if (isset($_SESSION['autenticado'])) {
            $layout .= '<button class="btn btn-outline-success me-md-3"><a href="carrinho.php" class="text-decoration-none link-success">Carrinho</a></button>
    ...
    public function footer(array $scripts = []): string
    {
        $layout = '    </div>
            ...
            <script rel="script" src="http://code.jquery.com/jquery-2.1.1.min.js"></script>
