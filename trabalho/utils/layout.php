...
class Layout
{
    public function header(array $styles = [], array $scripts = []): string
    {
        $layout = '
    <!DOCTYPE html>
    <html lang="en">
    ...
    <header class="p-3 mb-3 border-bottom shadow">
        ...
        if (isset($_SESSION['logado'])) {
            $layout .= '<button class="btn btn-outline-warning"><a href="carrinho.php" class="text-decoration-none link-warning">Carrinho</a></button>
