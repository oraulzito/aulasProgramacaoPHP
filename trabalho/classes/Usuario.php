...
class Usuario
{
    ...
    function contato(string $nome, string $email, string $telefone, string $mensagem, string $assunto)
    {
        $email = new Email();
        $email->enviaEmail($assunto, $mensagem, $nome, $email);
    }
        ...
        if (@$_REQUEST['nome'] !== '' and @$_REQUEST['email'] !== '' and @$_REQUEST['senha'] !== '' and @$_REQUEST['telefone'] !== '' and @$_REQUEST['cep'] !== '' and @$_REQUEST['rua'] !== '' and @$_REQUEST['bairro'] !== '' and @$_REQUEST['cidade'] !== '' and @$_REQUEST['uf'] !== '' and @$_REQUEST['pais'] !== '' and @$_REQUEST['numero'] != '') {
            ...
            if (isset($_FILES['foto'])) {
                if ($_FILES['foto']['type'] == 'image/gif'
                    ...
                    $foto = base64_encode($_FILES['foto']);
                } else {
                    $fotoInvalida = true;
                }
            } else {
