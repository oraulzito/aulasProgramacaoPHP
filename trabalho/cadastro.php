...
<div class="col-8 mx-auto my-4">
    <form id="userForm" class="shadow rounded" enctype="multipart/form-data"
        ...
        <div class="w-75 mx-auto py-4">
            ...
            <input required name="numero" class="form-control my-2" type="text" id="numero">

            <!-- Complemento-->
            <label for="complemento">Complemento</label>
            <input required name="complemento" class="form-control my-2" type="text" id="complemento">
